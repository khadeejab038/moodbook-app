...
class _EditProfileState extends State<EditProfile> {
  ...
  Future<void> _fetchUserData() async {
    try {
      model.User? currentUser = await DatabaseServicesUsers
    ...
    if (_formKey.currentState!.validate()) {
      try {
        ...
        if (currentUser != null) {
          ...
          await DatabaseServicesUsers.updateUserInFirestore(
                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      Center(
                        child: GestureDetector(
                          ...
                          child: CircleAvatar(
                            ...
                            child: ClipOval(
                              child: Image.asset(
                                AvatarUtils.getAvatarAsset(selectedAvatar),
                                fit: BoxFit.cover,
                                width: 200,
                                height: 200,
                              ),
                      ...
                      Wrap(
                        spacing: 8,
                        children: AvatarUtils.getAllAvatarTitles().map((avatarTitle) {
                          return GestureDetector(
                            onTap: () {
                              setState(() {
                                selectedAvatar = avatarTitle;
                              });
                            },
                            child: CircleAvatar(
                              backgroundColor: avatarTitle == selectedAvatar
                                  ? Colors.deepPurpleAccent
                                  : Colors.transparent,
                              radius: 30,
                              child: ClipOval(
                                child: Image.asset(
                                  AvatarUtils.getAvatarAsset(avatarTitle),
                                  fit: BoxFit.cover,
                                  width: 50,
                                  height: 50,
                                ),
